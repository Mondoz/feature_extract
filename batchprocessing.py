...
def main():
  ...
  inputCSV = os.path.join(outPath, 'testNEWCases.csv')
  outputFilepath = os.path.join(outPath, 'radiomics_featuresNEW.csv')
  progress_filename = os.path.join(outPath, 'pyrad_log.txt')
  params = os.path.join(outPath, 'exampleSettings', 'exampleCT.yaml')
